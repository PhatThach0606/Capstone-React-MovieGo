...
export const GroupTheather = createAsyncThunk(
  "GroupTheather",
...
const GroupTheatherReducer = createSlice({
  name: "GroupTheatherReducer",
  initialState,
  reducers: {},
  extraReducers: (builder) => {
    builder.addCase(GroupTheather.pending, (state) => {
      state.loading = true;
    });
    builder.addCase(GroupTheather.fulfilled, (state, action) => {
      state.loading = false;
      state.data = action.payload;
    });
    builder.addCase(GroupTheather.rejected, (state, action) => {
      state.loading = false;
...
export default GroupTheatherReducer.reducer;
