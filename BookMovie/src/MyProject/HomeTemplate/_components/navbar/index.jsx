    ...
    <div>
      <nav className="  bg-[#0F172A]">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a
            href="#"
            className="flex items-center space-x-3 rtl:space-x-reverse w-20 h-20 border-1 border-[#F5C518] bg-gradient-to-b from-[#4B0082]  to-[#D32F2F] rounded-[50%] leading-[50%]"
          >
            <img src="./image/logo.png" className="h-20 " alt="#" />
          </a>
          ...
          >
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border    md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 text-white ">
              <li className="bg-[#663399] rounded-[5px] hover:bg-[#FF7801]">
                <NavLink
                  to=""
                  //   className="block py-2 px-3 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500"
                  className={({ isActive }) => {
                    return isActive
                      ? "text-black block py-2 px-3 rounded-sm md:bg-transparent hover:bg-amber-300 "
                      : "hover:text-white block py-2 px-3 rounded-sm md:bg-transparent";
                  }}
                  aria-current="page"
                >
                  Home
              ...
              <li className="bg-[#FF7801] rounded-[5px] hover:bg-[#663399]">
                <NavLink
                  to="list-movie"
                  className={({ isActive }) => {
                    return isActive
                      ? "text-black block py-2 px-3 rounded-sm md:bg-transparent  "
                      : "text-white block py-2 px-3 rounded-sm md:bg-transparent";
                  }}
